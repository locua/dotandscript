...
before packages are loaded."
  ...
  ;; define compile site shell command and assign to "SPC o b"
  (defun compile-site ()
    (interactive)
    (shell-command "cd ~/src/kbase/ && ./gen.py build"))
  (spacemacs/set-leader-keys "ob" 'compile-site)
